...
import com.example.iss.databinding.RowLeaderboardsBinding;
...
public class LeaderboardsAdapter extends RecyclerView.Adapter<LeaderboardsAdapter.LeaderboardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LeaderboardViewHolder holder, int position) {
        ...
        holder.binding.name2.setText(user.getName());
        holder.binding.coins2.setText(String.valueOf(user.getCoins()));
        holder.binding.index2.setText(String.format("#%d", position+1));
